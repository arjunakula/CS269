...
def main():
    ...
    parser.add_argument(
	#FIXME: update below learnign rate again by looking at original github page
    ...
    with open('vlbert_tasks_large.yml', 'r') as f:
    ...
    #tbLogger = utils.tbLogger(timeStamp, savePath, task_names, ['TASK4'], task_num_iters, args.gradient_accumulation_steps)
    ...
    max_num_iter = min(task_num_iters.values())
    ...
    #task_iter_train = {name:None for name in ['TASK4']}
    #FIXME:
    task_count = {name:0 for name in task_ids}
    #task_count = {name:0 for name in ['TASK4']}
        ...
        for step in range(max_num_iter):
            ...
            #for task_id in ['TASK4']:
                ...
                for i in range(0,loop_times):
                    #FIXME: this is an extra condition. remove this later
                    #if(epochId <= 4):
                    #    break;
            ...
            #if task_id in ['TASK4'] and step % (20 * args.gradient_accumulation_steps) == 0 and step != 0 and default_gpu:
